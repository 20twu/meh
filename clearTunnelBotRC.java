 ...
 * An instance of clearTunnelBotRC is facing a tunnel that has at least one Thing on each intersection.
...
//Some of the work has been done for you.  clearTunnelBotRC already extends RobotSE and the superclass has been initialized.
public class clearTunnelBotRC extends RobotSE
{

public clearTunnelBotRC (City aCity, int aStreet, int anAvenue, Direction aDir, int numThings)
  ...
  {    City warsaw = new City(6,12);
      ...
      clearTunnelBotRC hauler1 = new clearTunnelBotRC(warsaw, 1, 1, Direction.EAST,0);
      clearTunnelBotRC hauler2 = new clearTunnelBotRC(warsaw, 4, 1, Direction.EAST,0);
