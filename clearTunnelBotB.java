 ...
 * An instance of clearTunnelBotB is facing a tunnel that has at least one Thing on each intersection.
...
//Some of the work has been done for you.  clearTunnelBotB already extends RobotSE and the superclass has been initialized.
public class clearTunnelBotB extends RobotSE
{

public clearTunnelBotB (City aCity, int aStreet, int anAvenue, Direction aDir, int numThings)
  ...
  {    City warsaw = new City(6,12);
      ...
      clearTunnelBotB hauler1 = new clearTunnelBotB(warsaw, 1, 1, Direction.EAST,0);
      clearTunnelBotB hauler2 = new clearTunnelBotB(warsaw, 4, 1, Direction.EAST,0);
