 ...
 * An instance of clearTunnelBotRT2 is facing a tunnel that has at least one Thing on each intersection.
...
//Some of the work has been done for you.  clearTunnelBotRT2 already extends RobotSE and the superclass has been initialized.
public class clearTunnelBotRT2 extends RobotSE
{

public clearTunnelBotRT2 (City aCity, int aStreet, int anAvenue, Direction aDir, int numThings)
   ...
   public void regression()
   {
       if(getAnother == true)
      {
            ...
            if(getAnother == true)
            {this.gettingAnother();}
            else{getAnother = true;}
        }
    }
    public void gettingAnother()
    {
        this.turnAround();
        this.move();
        this.regression();
  ...
  {    City warsaw = new City(6,12);
      ...
      clearTunnelBotRT2 hauler1 = new clearTunnelBotRT2(warsaw, 1, 1, Direction.EAST,0);
      clearTunnelBotRT2 hauler2 = new clearTunnelBotRT2(warsaw, 4, 1, Direction.EAST,0);
