 ...
 * An instance of clearTunnelBotC is facing a tunnel that has at least one Thing on each intersection.
...
//Some of the work has been done for you.  clearTunnelBotC already extends RobotSE and the superclass has been initialized.
public class clearTunnelBotC extends RobotSE
{

public clearTunnelBotC (City aCity, int aStreet, int anAvenue, Direction aDir, int numThings)
  ...
  {    City warsaw = new City(6,12);
      ...
      clearTunnelBotC hauler1 = new clearTunnelBotC(warsaw, 1, 1, Direction.EAST,0);
      clearTunnelBotC hauler2 = new clearTunnelBotC(warsaw, 4, 1, Direction.EAST,0);
